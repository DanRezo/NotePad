			...
			<div class="jumbotron notePadContainer">
				...
				<form action="createSongWithNewAlubum.do" method="POST">
					<div class="form-group">
						<input type="text" name="songTitle" placeholder="Song Title" /> <input
							type="text" name="artistName" placeholder="Artist Name" /><br>
						<br> <input type="text" name="albumTitle"
							placeholder="Album Title" /> <input type="text" name="albumYear"
							placeholder="Album Year" /><br> <br> <select
							name="genreId">
